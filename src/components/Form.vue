...
const homepageFormData = reactive({
  ...
  selectedFields: getDefaultSelectedFields('douyin'), // 默认选中所有字段
});
...
const getUserInfo = async () => {
  try {
    ...
    // 抖音专用版本，平台固定为 'douyin'
    const serviceCode = getServiceCodeByPlatform('douyin');
    ...
    const response = await fetch(`${API_CONFIG.BASE_URL}${API_ENDPOINTS.getUserInfo()}`, {
      ...
      body: JSON.stringify({
        ...
        service_code: serviceCode, // 传递服务编码，后端返回抖音平台的智能点
      }),
    });
...
<template>
  ...
  <div v-else class="form-container">
    ...
    <div class="header-section">
      <div class="header-title">抖音博主关键词批量查询</div>
    </div>
...
/* 抖音主题：确保所有输入框背景色为黑色 */
:root[data-theme="douyin"] :deep(.el-input__wrapper),
body[data-theme="douyin"] :deep(.el-input__wrapper),
[data-theme="douyin"] :deep(.el-input__wrapper),
html[data-theme="douyin"] :deep(.el-input__wrapper),
html body[data-theme="douyin"] :deep(.el-input__wrapper) {
...
/* 抖音主题：强制选择框背景色为黑色，覆盖 CSS 变量 */
:root[data-theme="douyin"] :deep(.el-select .el-input__wrapper),
body[data-theme="douyin"] :deep(.el-select .el-input__wrapper),
[data-theme="douyin"] :deep(.el-select .el-input__wrapper),
html[data-theme="douyin"] :deep(.el-select .el-input__wrapper),
html body[data-theme="douyin"] :deep(.el-select .el-input__wrapper) {
  background-color: #000000 !important;
  background: #000000 !important;
}
...
/* 抖音主题：确保选择框内选中值文字可见 - 覆盖所有可能的元素 */
:root[data-theme="douyin"] :deep(.el-select .el-input__inner),
body[data-theme="douyin"] :deep(.el-select .el-input__inner),
[data-theme="douyin"] :deep(.el-select .el-input__inner),
:root[data-theme="douyin"] :deep(.el-select__input),
body[data-theme="douyin"] :deep(.el-select__input),
[data-theme="douyin"] :deep(.el-select__input),
:root[data-theme="douyin"] :deep(.el-select__input-inner),
body[data-theme="douyin"] :deep(.el-select__input-inner),
[data-theme="douyin"] :deep(.el-select__input-inner),
:root[data-theme="douyin"] :deep(.el-select__selected-item),
body[data-theme="douyin"] :deep(.el-select__selected-item),
[data-theme="douyin"] :deep(.el-select__selected-item),
:root[data-theme="douyin"] :deep(.el-select__tags-text),
body[data-theme="douyin"] :deep(.el-select__tags-text),
[data-theme="douyin"] :deep(.el-select__tags-text),
:root[data-theme="douyin"] :deep(.el-select .el-input__suffix),
body[data-theme="douyin"] :deep(.el-select .el-input__suffix),
[data-theme="douyin"] :deep(.el-select .el-input__suffix),
:root[data-theme="douyin"] :deep(.el-select .el-input__suffix-inner),
body[data-theme="douyin"] :deep(.el-select .el-input__suffix-inner),
[data-theme="douyin"] :deep(.el-select .el-input__suffix-inner) {
  color: #FFFFFF !important;
}

/* 确保选择框背景色在抖音主题下正确 - 覆盖所有可能的背景色设置 */
:root[data-theme="douyin"] :deep(.el-select .el-input__wrapper),
body[data-theme="douyin"] :deep(.el-select .el-input__wrapper),
[data-theme="douyin"] :deep(.el-select .el-input__wrapper),
html[data-theme="douyin"] :deep(.el-select .el-input__wrapper),
html body[data-theme="douyin"] :deep(.el-select .el-input__wrapper),
:root[data-theme="douyin"] :deep(.el-select),
body[data-theme="douyin"] :deep(.el-select),
[data-theme="douyin"] :deep(.el-select),
html[data-theme="douyin"] :deep(.el-select),
html body[data-theme="douyin"] :deep(.el-select),
:root[data-theme="douyin"] :deep(.el-select__wrapper),
body[data-theme="douyin"] :deep(.el-select__wrapper),
[data-theme="douyin"] :deep(.el-select__wrapper),
html[data-theme="douyin"] :deep(.el-select__wrapper),
html body[data-theme="douyin"] :deep(.el-select__wrapper),
:root[data-theme="douyin"] :deep(.el-input__wrapper),
body[data-theme="douyin"] :deep(.el-input__wrapper),
[data-theme="douyin"] :deep(.el-input__wrapper),
html[data-theme="douyin"] :deep(.el-input__wrapper),
...
/* 特别处理输入框本身的背景色 */
:root[data-theme="douyin"] :deep(.el-select .el-input),
body[data-theme="douyin"] :deep(.el-select .el-input),
[data-theme="douyin"] :deep(.el-select .el-input),
:root[data-theme="douyin"] :deep(.el-select__input),
body[data-theme="douyin"] :deep(.el-select__input),
[data-theme="douyin"] :deep(.el-select__input) {
  background-color: transparent !important;
...
/* 抖音主题：强制选择框内所有文字为白色（使用通用选择器确保覆盖所有情况） */
:root[data-theme="douyin"] :deep(.el-select .el-input__wrapper *),
body[data-theme="douyin"] :deep(.el-select .el-input__wrapper *),
[data-theme="douyin"] :deep(.el-select .el-input__wrapper *),
html[data-theme="douyin"] :deep(.el-select .el-input__wrapper *),
...
/* 特别处理选择框内可能显示选中值的所有元素 */
:root[data-theme="douyin"] :deep(.el-select .el-input__wrapper span),
body[data-theme="douyin"] :deep(.el-select .el-input__wrapper span),
[data-theme="douyin"] :deep(.el-select .el-input__wrapper span),
html[data-theme="douyin"] :deep(.el-select .el-input__wrapper span),
html body[data-theme="douyin"] :deep(.el-select .el-input__wrapper span),
:root[data-theme="douyin"] :deep(.el-select .el-input__wrapper div),
body[data-theme="douyin"] :deep(.el-select .el-input__wrapper div),
[data-theme="douyin"] :deep(.el-select .el-input__wrapper div),
html[data-theme="douyin"] :deep(.el-select .el-input__wrapper div),
html body[data-theme="douyin"] :deep(.el-select .el-input__wrapper div),
:root[data-theme="douyin"] :deep(.el-input__wrapper span),
body[data-theme="douyin"] :deep(.el-input__wrapper span),
[data-theme="douyin"] :deep(.el-input__wrapper span),
html[data-theme="douyin"] :deep(.el-input__wrapper span),
html body[data-theme="douyin"] :deep(.el-input__wrapper span),
:root[data-theme="douyin"] :deep(.el-input__wrapper div),
body[data-theme="douyin"] :deep(.el-input__wrapper div),
[data-theme="douyin"] :deep(.el-input__wrapper div),
html[data-theme="douyin"] :deep(.el-input__wrapper div),
html body[data-theme="douyin"] :deep(.el-input__wrapper div) {
  color: #FFFFFF !important;
}
...
/* 抖音主题：确保卡片内选择框选中值文字可见 - 覆盖所有可能的元素 */
:root[data-theme="douyin"] .card :deep(.el-select__input),
body[data-theme="douyin"] .card :deep(.el-select__input),
[data-theme="douyin"] .card :deep(.el-select__input),
:root[data-theme="douyin"] .card :deep(.el-select .el-input__inner),
body[data-theme="douyin"] .card :deep(.el-select .el-input__inner),
[data-theme="douyin"] .card :deep(.el-select .el-input__inner),
:root[data-theme="douyin"] .card :deep(.el-select__selected-item),
body[data-theme="douyin"] .card :deep(.el-select__selected-item),
[data-theme="douyin"] .card :deep(.el-select__selected-item),
:root[data-theme="douyin"] .card :deep(.el-select__tags-text),
body[data-theme="douyin"] .card :deep(.el-select__tags-text),
[data-theme="douyin"] .card :deep(.el-select__tags-text),
:root[data-theme="douyin"] .card :deep(.el-select__input-inner),
body[data-theme="douyin"] .card :deep(.el-select__input-inner),
[data-theme="douyin"] .card :deep(.el-select__input-inner) {
  color: #FFFFFF !important;
}

/* ================================================================= */
/* 核心修复：强制 Select 组件在深色模式下显示为"深底白字" */
/* ================================================================= */

/* 1. 修复背景色 (关键步骤) */
/* 同时针对 Element Plus 新版 (.el-select__wrapper) 和旧版 (.el-input__wrapper) 结构 */
.card :deep(.el-select__wrapper),
.card :deep(.el-select .el-input__wrapper) {
  background-color: #1E1E1E !important; /* 强制使用深灰色背景 */
  background: #1E1E1E !important;
  box-shadow: 0 0 0 1px #333333 inset !important; /* 修复边框颜色 */
}

/* 2. 修复文字颜色 */
/* 确保选中的文字、输入框内的文字都是白色 */
.card :deep(.el-select__selected-item),
.card :deep(.el-select__wrapper .el-select__selected-item), 
...
/* 3. 修复 Placeholder (提示文字) 颜色 */
/* 避免"请选择"等提示文字看不清 */
.card :deep(.el-select__placeholder),
...
.card :deep(.el-select .el-input__wrapper:hover) {
  box-shadow: 0 0 0 1px #FF66CC inset !important; /* 悬停时显示粉色边框 */
}

.card :deep(.el-select__wrapper.is-focused),
.card :deep(.el-select .el-input__wrapper.is-focus) {
  box-shadow: 0 0 0 1px #FF66CC inset !important; /* 激活时显示粉色边框 */
}
</style>
